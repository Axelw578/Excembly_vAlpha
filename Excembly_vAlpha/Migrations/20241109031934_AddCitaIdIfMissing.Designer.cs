...
namespace Excembly_vAlpha.Migrations
{
    ...
    [Migration("20241109031934_AddCitaIdIfMissing")]
    partial class AddCitaIdIfMissing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Excembly_vAlpha.Models.Contratacion", b =>
                {
                    ...
                    b.Property<int>("PlanPersonalizadoCitaId")
                        .HasColumnType("int");

                    b.Property<int?>("PlanPersonalizadoId")
                        .HasColumnType("int");

                    b.Property<int>("PlanPersonalizadoServicioId")
                        .HasColumnType("int");

                    b.Property<int>("PlanPersonalizadoUsuarioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlanPersonalizadoUsuarioId", "PlanPersonalizadoCitaId", "PlanPersonalizadoServicioId");
            ...
            modelBuilder.Entity("Excembly_vAlpha.Models.ServicioAdicionalContratado", b =>
                {
                    ...
                    b.Property<int>("ServicioAdicionalPlanId")
                        .HasColumnType("int");

                    b.Property<int>("ServicioAdicionalServicioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ServicioAdicionalPlanId", "ServicioAdicionalServicioId");
            ...
            modelBuilder.Entity("Excembly_vAlpha.Models.Contratacion", b =>
                {
                    ...
                    b.HasOne("Excembly_vAlpha.Models.PlanPersonalizado", "PlanPersonalizado")
                        .WithMany()
                        .HasForeignKey("PlanPersonalizadoUsuarioId", "PlanPersonalizadoCitaId", "PlanPersonalizadoServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PlanPersonalizado");
            ...
            modelBuilder.Entity("Excembly_vAlpha.Models.ServicioAdicionalContratado", b =>
                {
                    ...
                    b.HasOne("Excembly_vAlpha.Models.ServicioAdicional", "ServicioAdicional")
                        .WithMany()
                        .HasForeignKey("ServicioAdicionalPlanId", "ServicioAdicionalServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
